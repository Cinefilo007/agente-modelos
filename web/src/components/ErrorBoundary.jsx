        ...
        if (this.state.hasError) {
            return (
                <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4">
                    ...
                    <div className="bg-gray-900 p-4 rounded-xl border border-gray-800 max-w-2xl w-full overflow-auto text-left">
                        <p className="font-mono text-red-400 text-sm mb-2">{this.state.error && this.state.error.toString()}</p>
