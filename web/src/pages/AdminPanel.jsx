...
import { LayoutDashboard, Users, DollarSign, CreditCard, TrendingUp, ArrowLeft, Save, Sparkles, Tag, Wallet, FileText, ShieldAlert, AlertTriangle, ShieldCheck, ShoppingBag, Loader, X, Gamepad2, Plus, Coins } from 'lucide-react';
        ...
        <div className="min-h-screen pb-20 pt-4 px-4 font-sans bg-transparent">
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="flex gap-2 mb-8 overflow-x-auto no-scrollbar pb-2">
                    ...
                    <TabButton id="casino" label="Casino" icon={Gamepad2} />
                </div>
                ...
                {activeTab === 'casino' && (
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 mb-20">
                        <CasinoTab themeColor={themeColor} showToast={showToast} />
                    </div>
                )}
            </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
            <div className="bg-card/40 border border-white/5 rounded-[32px] p-8">
                ...
                <div className="space-y-3 mb-10">
                    ...
                    {loading ? <div className="animate-pulse h-20 bg-white/5 rounded-2xl"></div> : (
                        prizes.map((prize) => (
