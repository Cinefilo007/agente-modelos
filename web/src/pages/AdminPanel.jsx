            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                    ...
                    <div className="bg-card/40 border border-white/5 rounded-2xl p-5 flex flex-col relative overflow-hidden group hover:bg-card/60 transition-colors">
                        ...
                        <span className="text-muted-foreground text-[10px] uppercase tracking-widest font-bold mb-2 opacity-80">Visitantes</span>
                        <span className="text-3xl font-bold text-white leading-none">{stats.visitors.toLocaleString()}</span>
                        <div className="flex items-center gap-1.5 mt-2 bg-green-500/10 w-fit px-2 py-0.5 rounded-full">
                    ...
                    <div className="bg-card/40 border border-white/5 rounded-2xl p-5 flex flex-col relative overflow-hidden group hover:bg-card/60 transition-colors">
                        ...
                        <span className="text-muted-foreground text-[10px] uppercase tracking-widest font-bold mb-2 opacity-80">Créditos</span>
                    ...
                    <div className="col-span-2 bg-gradient-to-r from-primary/20 via-purple-500/10 to-blue-500/10 border border-white/10 rounded-2xl p-6 flex items-center justify-between gap-6 shadow-xl">
                        ...
                        <Link to="/admin" className="px-5 py-3 bg-white text-black font-bold text-xs rounded-xl hover:scale-105 active:scale-95 transition-all shadow-[0_10px_20px_rgba(255,255,255,0.2)] whitespace-nowrap">
                            Configurar Bot
                        </Link>
                    </div>
                </div>
