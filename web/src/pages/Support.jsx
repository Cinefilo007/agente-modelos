    ...
    return (
        <div className="min-h-screen bg-black text-white pb-32 pt-6 px-4 max-w-lg mx-auto animate-in fade-in duration-500">
            ...
            <div className="flex items-center mb-10">
                <button onClick={() => navigate(-1)} className="p-2 rounded-full hover:bg-white/10 text-muted-foreground mr-2 transition-colors">
                    <ArrowLeft size={22} />
                </button>
                <div>
            ...
            <div className="space-y-3">
                {faqs.map((faq, i) => (
                    <div key={i} className="bg-white/5 border border-white/5 rounded-3xl p-5 hover:bg-white/10 transition-colors group cursor-default">
                        <h4 className="font-bold text-sm text-white mb-2 group-hover:text-primary transition-colors" style={themeColor ? { color: themeColor } : {}}>{faq.q}</h4>
